//
// Inspired by [monaco-mermaid](https://github.com/Yash-Singh1/monaco-mermaid/blob/main/index.ts)
//
const registerLanguage = (monacoEditor, editorElem) => {
    ...
    const expandKeywords = () => 
        Object.entries(keywords)
            .map( entry => 
                Object.fromEntries( Object.entries(entry[1]).map(deepEntry => [
                    entry[0] + capitalize(deepEntry[0]),
                    deepEntry[1],
                ])))
            .reduce((overallKeywords, nextKeyword) => ({
                ...overallKeywords,
                ...nextKeyword,
            }), {})
